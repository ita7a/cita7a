try{$('.u-msg.dots').removeClass('dots');$(".ubnr").remove();$(`<link rel="stylesheet" href="https://rawcdn.githack.com/ita7a/MuHanadta7a/526583dcf9535c42b2e7c97d9b0298d6d613e1e6/ita7a.css"></style>`).insertBefore("body");$('.hand.nosel.fl.uzr.border').css({'margin':'1px 0',borderRight:'1px solid #EDEDED',borderLeft:'1px solid #adadad',borderTop:'1px solid #EDEDED',borderBottom:'1px solid #EDEDED',paddingTop:'3px',borderRadius:'5px'});$(`<link href="https://fonts.googleapis.com/css?family=Changa" rel="stylesheet">
